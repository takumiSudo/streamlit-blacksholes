# Credit: https://github.com/prudhvi-reddy-m/BlackScholes/tree/main
#         Prudhvi created most of the content here. This implementation is for experimentation purposes only and all credits go to him!
...
# Page configuration
st.set_page_config(
    page_title="Black-Scholes Option Pricing Model (StreamLit Implementation)",
    page_icon="🚀",
    layout="wide",
...
with st.sidebar:
    ...
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`Takumi`</a>', unsafe_allow_html=True)
...
st.title("Black-Scholes Pricing Model Implementation")
